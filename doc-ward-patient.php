...
<?php 
	...
	if (!isset($_SESSION['user_id']) || 'doctor' != $_SESSION['access']) {
        ...
        while ($ward_patient = mysqli_fetch_assoc($ward_patients)) {
            ...
            $ward_patients_list .= "<td>
                                    <div class='action-container'>
                                        <a class='edit-button' href=\"modify-doc-patient.php?user_id={$ward_patient['id']}&page=doc-ward-patient.php\">Edit &nbsp <i class='fa-solid fa-pen-to-square'></i></a>
